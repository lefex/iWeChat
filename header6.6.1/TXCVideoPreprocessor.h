...
@class NSDate, NSString, TXCBeautifyFilter, TXCCropFilter, TXCFilterFilter, TXCGaussianBlurFilter, TXCGreenScreenFilter, TXCPituFilter, TXCRGB2YUVOutput, TXCWaterMark, TXCYUV2RGBInput, UIImage, UIView;
